    ...
    return (
      <div className="App">
        ...
        <div className="navbar">
          <a
            style={this.state.airShow ? navStyle : {}}
            href="#main-page"
            name="airShow"
            onClick={this.handleAir}
          >
            主页{" "}
          </a>{" "}
          <a
            style={this.state.searchShow ? navStyle : {}}
            href="#search-page"
            name="searchShow"
          ...
          <a
            style={this.state.recommShow ? navStyle : {}}
            href="#recommendation-page"
            name="recommShow"
            onClick={this.handleRecomm}
          >
            推荐{" "}
          </a>{" "}
          <a
            style={this.state.aboutShow ? navStyle : {}}
            href="#about-page"
            name="aboutShow"
        ...
        {this.state.aboutShow ? <About /> : null}{" "}
      </div>
    )
  }
}
